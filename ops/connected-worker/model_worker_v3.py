...
from tools.model_provider_shadow_v3 import (  # noqa: E402
...
_HISTORICAL_SHADOW_TOOL_SHA256 = (
...
class RuntimePolicy:
    ...
    def load(cls, path: Path) -> "RuntimePolicy":
        ...
        profile_paths = {
            _sha256_file(PROFILE_PATH): PROFILE_PATH,
            _sha256_file(CURRENT_PROFILE_PATH): CURRENT_PROFILE_PATH,
        }
        ...
        expected_tool_sha256 = (
            ...
            if profile_path == PROFILE_PATH
                ...
                REPOSITORY_ROOT / "tools" / "model_provider_shadow_v3.py"
            )
        )
